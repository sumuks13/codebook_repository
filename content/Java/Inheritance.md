...
## 9. Which class in Java is superclass of every other class? 
...
## 11. In OOPS, what is meant by composition?
...
## 12. What is meant by aggregation?
...
## 13. Why there are no pointers in Java?
...
## 14. If there are no pointers in Java, then why do we get NullPointerException?
...
## 15. What is the purpose of ‘super’ keyword in java? 
...
## 16. Is it possible to use this() and super() both in same constructor?

No, As per Java specification, super() or this() must be the first statement in a constructor.

## 17. What is the meaning of object cloning in Java? 
