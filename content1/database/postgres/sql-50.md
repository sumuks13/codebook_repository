...
Write a solution to find the person_name of the last person that can fit on the bus without exceeding the weight limit. The weight limit is 1000 kilograms.
...
Write a solution to report the IDs of the employees whose salary is strictly less than $30000 and whose manager left the company. Return the result table ordered by employee_id.
